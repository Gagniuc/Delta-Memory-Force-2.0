...
For f = 1 To Len(cobra69)
g = g & Asc(Mid(cobra69, f, 1)) & ","
Next f

cobra69 = Mid(g, 1, Len(g) - 1)

ShellExecute hwnd, "open", "http://www.NovusOrdo.ro/Cumpara.php?Soft=DMF&ID=" & cobra69, vbNullString, vbNullString, conSwNormal
End Sub
