...
'WindowsNT
If InStr(LCase(WinCx), "nt") <> 0 Then
...
If InStr(LCase(WinCx), "nt") <> 0 Then
    ...
    dblCounterValue = _
        ...
        ZeusEu = Format$(dblCounterValue, "0")
        End If
        
Statbar = Int(ZeusEu / 10)
RauRau = Int(ZeusEu)
